...
class XprFile:
    ...
    def get_textures(self):
        ...
        for res in self.resources:
            ...
            if res.type != XprResourceType.Texture:
...
class XprInjector:
    ...
    def find_texture(
        ...
        for t in self.xpr.get_textures():
    ...
    for tex in textures:
        ...
        try:
            ...
            if info is None:
                ...
                raise Exception(
                    "Textura no encontrada en XPR"
                )



            data=convert_texture(
                png,
                tex
            )
...
def main():
    ...
    try:
        ...
        xpr=filedialog.askopenfilename(
        ...
        json_file=filedialog.askopenfilename(
            title="Selecciona textures.json",
            filetypes=[
                (
                    "JSON",
                    "*.json"
        ...
        output=filedialog.asksaveasfilename(
            title="Guardar XPR nuevo",
            defaultextension=".xpr",
            filetypes=[
                (
                    "Xbox Resource",
                    "*.xpr"
