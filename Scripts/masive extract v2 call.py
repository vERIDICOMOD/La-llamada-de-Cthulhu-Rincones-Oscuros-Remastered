...
def main():
    ...
    try:
        ...
        carpeta_padre=filedialog.askdirectory(
            title="Selecciona carpeta padre"
        )
        ...
        if not archivos:
            ...
            print("No se encontraron Textures.xpr")
            input("ENTER para salir")
            return
        ...
        for i,xpr in enumerate(archivos,1):
